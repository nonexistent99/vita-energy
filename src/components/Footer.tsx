  ...
  return (
    <footer className="py-12" style={{ background: '#0f071a', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
      <div className="max-w-3xl mx-auto px-5 md:px-8 text-center">
        <span className="text-xl font-black tracking-tight text-white mb-4 block">
        ...
        <div className="flex justify-center gap-6 mb-10">
          ...
          <a href="https://instagram.com/vitaenergy" target="_blank" rel="noopener noreferrer"
...
function InstagramIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect width="20" height="20" x="2" y="2" rx="5"/><circle cx="12" cy="12" r="5"/><circle cx="17.5" cy="6.5" r="1.5" fill="currentColor" stroke="none"/>
    </svg>
  );
}
